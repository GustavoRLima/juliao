        ...
        <div class="bg-white dark:bg-gray-900 shadow-md mt-6 w-11/12 mx-auto rounded-xl overflow-hidden">
            ...
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                ...
                <tbody class="bg-white dark:bg-gray-900 divide-y divide-gray-200 dark:divide-gray-700">
                    <template v-for="competidor in props.competicoes.data" :key="competidor.id">
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-800 transition">
                            <td class="px-6 py-4 text-sm text-gray-900 dark:text-gray-100">{{ competidor.id }}</td>
                            <td class="px-6 py-4 text-sm text-gray-900 dark:text-gray-100">{{ competidor.descricao }}</td>
                            <td class="px-6 py-4 text-sm text-gray-900 dark:text-gray-100">{{ competidor.data_evento }}</td>
                            <td class="px-6 py-4 text-sm text-gray-900 dark:text-gray-100">
                                <NavLink
                                    :href="route('competicoes.edit', [competidor])"
                                ...
                                <FormButton
                                    ...
                                    @click="onDeleteItem(route('competicoes.destroy', competidor.id))"
                                >
